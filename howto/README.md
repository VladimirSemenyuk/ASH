...
2. Внесение изменений в проект
	1. Добавление нового инструмента или редактирование существующего
	2. Добавление новой модели
	3. Добавление переводов
	4. Запуск тестов
	5. Запуск локального сервера
3. Генерация паспортов	
...
10. Добавь переводы, если их нет. **[см. раздел 2.3](#translations)**
11. Запусти тесты. **[см. раздел 2.4](#tests)**
12. Запусти локальный сервер для ручной проверки. **[см. раздел 2.5](#server)**
13. Загрузи все на сервер. **[см. раздел 2.6](#deploy)**

### 2.2 [Добавление новой модели](id:new-model)

1. Придумать id `модели` на **английском языке**.
2. Добавить инструмент этой модели, указав в его поле `model` придуманный `id`. **[см. раздел 2.1](#new-instrument)**
...
4. Добавь переводы, если их нет. **[см. раздел 2.3](#translations)**
5. Запусти тесты. **[см. раздел 2.4](#tests)**
6. Запусти локальный сервер для ручной проверки. **[см. раздел 2.5](#server)**
7. Загрузи все на сервер. **[см. раздел 2.6](#deploy)**
...
2. Подожди немного, пока не увидишь строку `Started connect web server on http://localhost:7000`. **Внимание! Сервер запуститься только если тесты прошли упешно. [см. раздел 2.4](#tests)**
...
### 2.6 [Загрузка на сервер](id:server)
